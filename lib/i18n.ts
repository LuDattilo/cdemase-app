...
const IT: Record<string, string> = {
  ...
  "catalog.search.placeholder": "Cerca: planimetria, demolizione, PD0001...",
  ...
  "field.servizio": "Servizio",
  "field.servizio.hint": "1 lettera",
  "field.statoFase": "Stato/Fase",
  "field.statoFase.hint": "0 o codice stato",
  "field.fase": "Fase",
  ...
  "validator.input.placeholder": "es. RMB1284-ADD-RELGENERA-XX-RT-Z-PD0001",
  ...
  "reference.tab.servizi": "Servizi e Stato/Fase (Tab. 16)",
  ...
  "reference.stati.title": "Stato/Fase (2° carattere)",
};
...
const EN: Record<string, string> = {
  ...
  "catalog.search.placeholder": "Search: floor plan, demolition, PD0001...",
  ...
  "field.servizio": "Service",
  "field.servizio.hint": "1 letter",
  "field.statoFase": "Status/Phase",
  "field.statoFase.hint": "0 or status code",
  "field.fase": "Phase",
  ...
  "validator.input.placeholder": "e.g. RMB1284-ADD-RELGENERA-XX-RT-Z-PD0001",
  ...
  "reference.tab.servizi": "Services and Status/Phase (Tab. 16)",
  ...
  "reference.stati.title": "Status/Phase (2nd character)",
};
